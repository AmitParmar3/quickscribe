  ...
  return (
    <main className="relative min-h-screen w-full flex items-center justify-center bg-background text-foreground">
      ...
      <div className="relative z-10 flex flex-row items-center justify-center w-full h-screen">
        ...
        <div className="flex-1 flex flex-col justify-center items-start pl-4 -ml-4 max-w-md h-full">
          <SplitText
            text="QuickScribe"
            className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl xl:text-[10rem] font-bold text-left leading-tight"
            delay={20}
            duration={1.5}
            ease="power3.out"
            splitType="chars"
          ...
          <GradientText
            ...
            animationSpeed={3}
            showBorder={false}
            className="text-xl opacity-80 mt-8 text-left max-w-xs"
          >
            Your fastest way to transcribe and summarize files
          </GradientText>
        </div>
        {/* Right: Upload section with toggle */}
        <div className="flex-1 flex flex-col items-end justify-center pr-8 w-full space-y-12">
          {/* Toggle buttons */}
          ...
          {mode === 'translate' ? (
            <div className="w-full">
              {/* Subtitle Only Form (reuse existing component) */}
              <SubtitleOnlyForm />
            </div>
          ) : (
            <form
              onSubmit={handleSubmit(onSubmit)}
              className="bg-card/50 backdrop-blur-sm rounded-3xl shadow-xl border border-border/50 p-12 dark:bg-card/30 dark:border-border/30 w-full space-y-12"
            >
