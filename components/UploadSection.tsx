...
export default function UploadSection() {
  ...
  return (
    <section id="upload-section" className="min-h-screen w-full flex items-center justify-center bg-background/50 backdrop-blur-sm">
      {/* Two-column layout */}
                ...
                {mode === 'translate' ? (
                  ...
                  <div className="text-center text-muted-foreground">
                    <p className="text-lg mb-4">
                      {mode === 'assign' ? 'Speaker Assignment' : 'Workstation'} Mode
                    </p>
                    <p className="text-sm">
                      {mode === 'assign' 
                        ? 'Coming soon - Assign speakers to your subtitles' 
                        : 'Coming soon - Full video editing workstation'
                      }
                    </p>
                  </div>
                )}
